...
import { listStudents, updateStudent, deleteStudentAndAssociatedData } from '../../../firebase/students';
...
export default function StudentsManagement() {
  ...
  return (
    <Container maxWidth="lg" sx={{ py: 3 }}>
      ...
      <Paper elevation={3} sx={{ p: 3, mt: 0, backgroundColor: colors.white, borderRadius: 3, boxShadow: 3 }}>
